        ...
        return `
            ...
            <div class="chat-container">
                ...
                <div class="chat-input">
                    ...
                    <button class="send-btn" type="button" aria-label="Send message"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false" width="20" height="20" fill="currentColor"><path d="M2.01 21L23 12 2.01 3 2 10l15 2-15 2z"/></svg></button>
                </div>
            </div>
        `;
    }
...
/* Self-initialize once per page (replaces the old per-page init block). */
